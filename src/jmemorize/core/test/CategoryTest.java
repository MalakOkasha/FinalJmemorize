...
import static jmemorize.core.Category.Events.*;
...
public class CategoryTest extends TestCase implements CategoryObserver
{
    ...
    {
        private Category.Events m_type;
        private Card m_card;
        private int  m_level;
        
        CardEvent(Category.Events type, Card card, int level)
        {
            m_type  = type;
            m_card  = card;
            m_level = level;
        ...
        public void assertEvent(Category.Events type, Card card, int level, Category category)
        {
    ...
    class CategoryEvent implements TestEvent
    {
        ...
        CategoryEvent(Category.Events type, Category category)
        {
            m_type     = type;
            m_category = category;
        }
     ...
     */
    public void onCategoryEvent(Category.Events type, Category category)
    {
     ...
     * @see jmemorize.core.CategoryObserver
     */
    public void onCardEvent(Category.Events type, Card card, Category category, int deck, Category.Events Events)
    {
