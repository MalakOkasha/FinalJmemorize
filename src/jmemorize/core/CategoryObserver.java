...
public interface CategoryObserver
{
     ...
     * @param Events
     */
    void onCardEvent(Category.Events type, Card card, Category category, int deck, Category.Events Events);
     ...
     */
    void onCategoryEvent(Category.Events type, Category category);
}
