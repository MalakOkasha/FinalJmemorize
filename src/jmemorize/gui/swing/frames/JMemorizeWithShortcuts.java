...
public class JMemorizeWithShortcuts extends JFrame {
    ...
    public JMemorizeWithShortcuts() {
        ...
        textArea.getActionMap().put("prevAction", prevAction);
        ...
        textArea.getActionMap().put("openAction", openAction);
    ...
    // Method to edit the current flashcard
